...
#define STRING_VERSION_CONFIG_H __DATE__ " 9/8/2015 " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(kagedws6, Folgertech Prusa i3)" // Who made the changes.
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  #define PID_dT ((16 * 8.0)/(F_CPU / 64.0 / 256.0)) //sampling period of the temperature routine
